...
*/
var MongoDBAtlasVectorSearch = class MongoDBAtlasVectorSearch extends _langchain_core_vectorstores.VectorStore {
	collection;
	indexName;
	textKey;
	embeddingKey;
	...
	constructor(embeddingsOrDbConfig, args) {
		...
		this.caller = new _langchain_core_utils_async_caller.AsyncCaller(libArgs);
	...
	*/
	async maxMarginalRelevanceSearch(query, options) {
		...
		return (0, _langchain_core_utils_math.maximalMarginalRelevance)(queryEmbedding, resultDocs.map((doc) => doc[0].metadata[this.embeddingKey]), lambda, k).map((idx) => {
	...
	*/
	async delete(params) {
		const chunkIds = (0, _langchain_core_utils_chunk_array.chunkArray)(params.ids, 50);
