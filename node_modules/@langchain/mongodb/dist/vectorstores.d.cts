...
import { Document as Document$1, DocumentInterface } from "@langchain/core/documents";
...
declare class MongoDBAtlasVectorSearch extends VectorStore {
  ...
  private caller;
  private readonly useAutoEmbedding;
   ...
   */
  similaritySearchWithScore(query: string, k?: number, filter?: this["FilterType"] | undefined): Promise<[Document$1, number][]>;
  /**
   ...
   */
  similaritySearch(query: string, k?: number, filter?: this["FilterType"] | undefined): Promise<DocumentInterface[]>;
  private textBasedSearchWithScore;
  /**
  ...
  static fromTexts(texts: string[], metadatas: object[] | object, dbConfig: MongoDBAtlasVectorSearchLibArgs & {
    ids?: string[];
  }): Promise<MongoDBAtlasVectorSearch>;
  /**
   * Static method to create an instance of MongoDBAtlasVectorSearch from a
  ...
  static fromDocuments(docs: Document$1[], dbConfig: MongoDBAtlasVectorSearchLibArgs & {
    ids?: string[];
  }): Promise<MongoDBAtlasVectorSearch>;
  /**
